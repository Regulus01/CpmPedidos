        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    preco = table.Column<decimal>(type: "numeric(17,5)", precision: 17, scale: 5, nullable: false),
                    ativo = table.Column<bool>(type: "boolean", nullable: false),
                    id_cidade = table.Column<int>(type: "integer", nullable: false),
                    criado_em = table.Column<DateTime>(type: "timestamp with time zone", nullable: false)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_tb_combo_tb_imagem_id_cidade",
                        column: x => x.id_cidade,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_tb_promocao_produto_tb_imagem_id_cidade",
                        column: x => x.id_cidade,
                        principalTable: "tb_imagem",
                        principalColumn: "id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_tb_promocao_produto_id_cidade",
