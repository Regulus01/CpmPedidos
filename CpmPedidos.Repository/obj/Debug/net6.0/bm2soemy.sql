...
CREATE TABLE tb_combo (
    ...
    preco numeric(17,5) NOT NULL,
    ativo boolean NOT NULL,
    id_cidade integer NOT NULL,
    criado_em timestamp with time zone NOT NULL,
    CONSTRAINT "PK_tb_combo" PRIMARY KEY (id),
    CONSTRAINT "FK_tb_combo_tb_imagem_id_cidade" FOREIGN KEY (id_cidade) REFERENCES tb_imagem (id) ON DELETE CASCADE
);
...
CREATE TABLE tb_promocao_produto (
    ...
    CONSTRAINT "FK_tb_promocao_produto_tb_imagem_id_cidade" FOREIGN KEY (id_cidade) REFERENCES tb_imagem (id) ON DELETE CASCADE,
...
CREATE INDEX "IX_tb_combo_id_cidade" ON tb_combo (id_cidade);
...
CREATE INDEX "IX_tb_promocao_produto_id_cidade" ON tb_promocao_produto (id_cidade);

CREATE INDEX "IX_tb_promocao_produto_id_produto" ON tb_promocao_produto (id_produto);

INSERT INTO "__EFMigrationsHistory" ("MigrationId", "ProductVersion")
VALUES ('20220906133732_Init', '6.0.8');
